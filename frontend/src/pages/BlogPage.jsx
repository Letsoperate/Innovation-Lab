  ...
  return (
    <div className="max-w-[900px] mx-auto px-4 sm:px-6 py-12">
      <div className="text-center mb-10">
        ...
        <h1 className="text-3xl font-bold text-[#111827] mb-3">Blog & Updates</h1>
        ...
        <div className="space-y-4">
          {blogPosts.map((post) => (
            <article key={post.id} className="p-6 bg-white border border-gray-200 rounded-xl hover:shadow-md transition-shadow cursor-pointer group">
              ...
              <h2 className="text-lg font-bold text-[#111827] mb-2 group-hover:text-[#009639] transition-colors">{post.title}</h2>
